...
<div class="drawer">
	...
	<div class="drawer-side">
		...
		<ul
			class="menu p-4 w-80 bg-base-100 text-base-content flex gap-2 text-lg uppercase tracking-widest"
		>
			...
			<li>
				<a href="https://www.instagram.com/bovedasecreta/" target="_blank"
					><svg
						xmlns="http://www.w3.org/2000/svg"
						class="h-6 fill-yellow-500 self-center"
						viewBox="0 0 30 30"
						><path
